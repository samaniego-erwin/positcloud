...
* Install [Python](https://www.python.org/downloads/) if it’s not already installed. 
...
## RUN THE SCRIPT
* From the terminal, run the following command to clone git repository
```shell
git clone https://github.com/samaniego-erwin/positcloud.git
```
