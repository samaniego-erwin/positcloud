...
class NewSpacePage:
    ...
    def click_newly_created_space(self):
        # self.driver.find_element(By.XPATH, "//div[normalize-space()='MySpace']").click()
    ...
    def verify_rstudio_ide_loads(self):
        try:
            ...
            # ide = self.driver.find_element(By.XPATH, "//iframe[@id='contentIFrame']")
            # ide = self.driver.find_element(By.ID, "rstudio_shell_widget")
